...
export const ACTIONS: ActionSpec[] = [
  ...
  define(null, "read", "credits.read", "הקרדיטים שלי", "כמה קרדיטים יש לגולש (מהקצבה היומית ובונוס), מתי מתחדשים, כמה חברים הצטרפו דרך הקישור האישי שלו, הקישור עצמו והמחירון."),
  define(null, "write", "credits.open", "דף הקרדיטים", "פותח את דף הקרדיטים: היתרה, הקישור האישי להזמנת חברים, המחירון וההסבר המלא."),
