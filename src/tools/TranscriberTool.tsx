              ...
              <div className="setting-field">
                ...
                <small>
                  {settings.engine === "fast"
                    ? "מנתח שיר שלם תוך שניות. מומלץ כמעט תמיד."
                    : "מדויק יותר על הקלטות צפופות, אבל יכול לקחת כמה דקות."}
                </small>
              </div>
            </div>
          </div>
              ...
              <div className="processing-bottom">
                <small>
                  {settings.engine === "deep"
                    ? "הזיהוי המעמיק עשוי לקחת כמה דקות לשיר שלם — הכול נעשה במכשיר שלך, והשיר לא נשלח לשום שרת."
      ...
      <section className="how-it-works">
        ...
        <div className="process-grid">
          ...
          <div>
            ...
            <AudioWaveform />
            <h3>המנוע מקשיב</h3>
            <p>האתר מזהה גובה, התחלה ומשך לכל צליל, ומעריך קצב וסולם.</p>
          </div>
          <div>
            <span>03</span>
            <FileMusic />
