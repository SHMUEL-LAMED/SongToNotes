...
קרדיטים: הכלים שרצים בדפדפן חינמיים ובלי הגבלה. פעולות שרצות בשרת עולות קרדיטים — הודעה לעוזר, תמלול ומילים מסונכרנות (לפי דקות), עיבוד טקסט ב־AI (לפי אורך), הקראה לקובץ MP3, הפרדת שירה ב־AI וזיהוי שיר. כל חשבון מחובר מקבל קצבה חינמית בכל יום (מתחדשת בחצות, שעון ישראל). לכל חשבון יש קישור אישי: מי שנכנס דרכו מזכה בקרדיט, וחבר שמצטרף דרכו מזכה בבונוס גדול ומגדיל לתמיד את הקצבה היומית; החבר מקבל מתנת הצטרפות. בונוס לא פג. אם פעולה נכשלת, הקרדיטים חוזרים. אפשר גם לקנות "חופשי" — שבועי או חודשי, בתשלום אחד ב־PayPal, בלי מנוי ובלי חידוש אוטומטי: בזמן החופשי כל פעולות השרת לא עולות קרדיטים, עד תקרת שימוש הוגן יומית (המחירים והתקרה בדף הקרדיטים, כשהמכירה פעילה). הכול מוסבר בדף "קרדיטים והזמנת חברים" (credits.open), והמספרים המדויקים של הגולש ב־credits.read.
